...
#define SOME_STATES_NOT_INDEXED 1
      ...
      public:
         ...
         */
		  NUPICCOREDLL_API Cells4(UInt nColumns =0, UInt nCellsPerCol =0,
         ...
         */
		NUPICCOREDLL_API void compute(Real* input, Real* output, bool doInference, bool doLearning);
