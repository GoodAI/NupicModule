    ...
    namespace cla_classifier
    {
      ...
      class ClassifierResult
      {
        public:
           ...
           * Constructor.
           */
		  NUPICCOREDLL_API ClassifierResult() {}

          /**
           * Destructor - frees memory allocated during lifespan.
           */
		  NUPICCOREDLL_API virtual ~ClassifierResult();
           ...
           */
		  NUPICCOREDLL_API virtual map<Int, vector<Real64>*>::const_iterator begin()
          {
           ...
           * Iterator method end.
           */
		  NUPICCOREDLL_API virtual map<Int, vector<Real64>*>::const_iterator end()
          {
            return result_.end();
          }
