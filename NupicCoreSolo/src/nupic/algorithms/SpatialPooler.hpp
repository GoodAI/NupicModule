...
#ifdef NUPIC_CORE_EXPORTS
#define NUPICCOREDLL_API __declspec(dllexport) 
#else
#define NUPICCOREDLL_API __declspec(dllimport) 
#endif
  ...
  namespace algorithms {
    namespace spatial_pooler {
       ...
       */
		class SpatialPooler {
        public:
		  NUPICCOREDLL_API SpatialPooler();
		  NUPICCOREDLL_API SpatialPooler(vector<UInt> inputDimensions,
		  ...
		  NUPICCOREDLL_API virtual ~SpatialPooler() {}
           ...
           */
		  NUPICCOREDLL_API virtual void compute(UInt inputVector[], bool learn,
...
//          virtual void read(SpatialPoolerProto::Reader& proto);
          ...
          */
		  NUPICCOREDLL_API void setPotentialRadius(UInt potentialRadius);
          /**
          ...
          */
		  NUPICCOREDLL_API void setPotentialPct(Real potentialPct);
          ...
          */
		  NUPICCOREDLL_API void setGlobalInhibition(bool globalInhibition);
          ...
          */
		  NUPICCOREDLL_API void setNumActiveColumnsPerInhArea(UInt numActiveColumnsPerInhArea);
          ...
          */
		  NUPICCOREDLL_API void setLocalAreaDensity(Real localAreaDensity);
          ...
          */
		  NUPICCOREDLL_API void setStimulusThreshold(UInt stimulusThreshold);
          ...
          */
		  NUPICCOREDLL_API void setInhibitionRadius(UInt inhibitionRadius);
          ...
          */
		  NUPICCOREDLL_API void setDutyCyclePeriod(UInt dutyCyclePeriod);
          ...
          */
		  NUPICCOREDLL_API void setMaxBoost(Real maxBoost);
          ...
          */
		  NUPICCOREDLL_API void setIterationNum(UInt iterationNum);
          ...
          */
		  NUPICCOREDLL_API void setIterationLearnNum(UInt iterationLearnNum);
          ...
          */
		  NUPICCOREDLL_API void setSpVerbosity(UInt spVerbosity);
          ...
          */
		  NUPICCOREDLL_API void setWrapAround(bool wrapAround);
          ...
          */
		  NUPICCOREDLL_API void setUpdatePeriod(UInt updatePeriod);
          ...
          */
		  NUPICCOREDLL_API void setSynPermTrimThreshold(Real synPermTrimThreshold);
          ...
          */
		  NUPICCOREDLL_API void setSynPermActiveInc(Real synPermActiveInc);
          ...
          */
		  NUPICCOREDLL_API void setSynPermInactiveDec(Real synPermInactiveDec);
          ...
          */
		  NUPICCOREDLL_API void setSynPermBelowStimulusInc(Real synPermBelowStimulusInc);
          ...
          */
          ...
          being connected.
          */
		  NUPICCOREDLL_API void setSynPermConnected(Real setSynPermConnected);
          ...
          */
		  NUPICCOREDLL_API void setMinPctOverlapDutyCycles(Real minPctOverlapDutyCycles);
          ...
          */
		  NUPICCOREDLL_API void setMinPctActiveDutyCycles(Real minPctActiveDutyCycles);
          ...
          */
		  NUPICCOREDLL_API void setBoostFactors(Real boostFactors[]);
          ...
          */
		  NUPICCOREDLL_API void setOverlapDutyCycles(Real overlapDutyCycles[]);
          ...
          */
		  NUPICCOREDLL_API void setActiveDutyCycles(Real activeDutyCycles[]);
          ...
          */
		  NUPICCOREDLL_API void setMinOverlapDutyCycles(Real minOverlapDutyCycles[]);
          ...
          */
		  NUPICCOREDLL_API void setMinActiveDutyCycles(Real minActiveDutyCycles[]);
